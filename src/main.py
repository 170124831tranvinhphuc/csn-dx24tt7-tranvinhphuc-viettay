...
# Split dataset: 20,000 train samples, 5,000 test samples
...
# 3. HELPER: CENTER OF MASS ALIGNMENT
...
class DigitRecognizerApp:
    ...
    def __init__(self, root):
        ...
        self.root.title("MNIST Digit Recognizer - KNN Model")
    ...
    def predict_digit(self):
        ...
        # Resize to 20x20 and pad to 28x28 (Standard MNIST format)
